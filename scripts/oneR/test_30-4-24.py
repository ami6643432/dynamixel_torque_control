...
def main():
    ...
    try:
        ...
        while True:
            ...
            pos = dynamixel_obj1.PRESENT_POSITION*0.088
            ...
            # ep = pd - dynamixel_obj1.PRESENT_POSITION*0.088
            # ev = 0 - dynamixel_obj1.PRESENT_VELOCITY * 0.229 * (360/60)
            ...
            # dynamixel_obj1.set_goal_curr_callback(round(tau1))
    finally:
